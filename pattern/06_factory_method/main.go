...
// Паттерн "фабрика" продемонстрирован на примере реализации разными провайдерами интерфейса TransactionProviderConcrete.
...
// Вообще реализация "фабрики" в го отличается от классической. Язык позволяет полную реализацию, но в ней нет необходимости.
